...
feature 'Users' do
  ...
  scenario 'Users can sign up' do
    ...
    expect(page).to have_content('The currently logged in user is: sleepyhollow@email.com')
  ...
  scenario 'Users can sign in and sign out' do
    ...
    expect(page).to have_content('The currently logged in user is: spartacus@email.com')
    expect(page).to have_content('Sign Out')
    expect(page).to have_no_content('Sign In')
    ...
    expect(page).to have_no_content('Sign Out')
    expect(page).to have_no_content('The currently logged in user is: spartacus@email.com')
